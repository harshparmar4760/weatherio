...
export const updateWeather = function (lat, lon) {
    ...
    fetchData(url.currentWeather(lat, lon), function (currentWeather) {
        ...
        const [{descipition, icon }] = weather;
    ...
    <!-- wind  -->
            ...
            for (const [index, data] of forecastList.entries()) {
                ...
                tempLi.innerHTML = `
                    <div class="card card-sm slider-card">
                        ...
                        <img src="./assets/images/weather_icons/${icon}.png" width="48" height="48" loading="lazy" alt="${descipition}" class="weather-icon" title="${descipition}">
             ...
             */
            forecastSection.innerHTML = `
                <h2 class="title-2" id="forecast-lable">5 Days Forecast</h2>
            ...
            for (let i = 7, len = forecastList.length; i < len; i += 8) {
                ...
                const [{icon , descipition}] = weather
                ...
                li.innerHTML = `
                    ...
                    <div class="icon-wrapper">
                        <img src="./assets/images/weather_icons/${icon}.png" width="36" height="36"  alt="${descipition}" class="weather-icon" title="${descipition}">
